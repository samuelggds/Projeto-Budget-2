...
Deno.serve(async (request) => {
  ...
  try {
    ...
    const { data, error } = await adminClient.rpc("activate_app_subscription");
    ...
    const message = error instanceof Error ? error.message : "Não foi possível ativar a mensalidade";
